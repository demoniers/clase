    ...
    public static void main(String[] args) {
        ...
        while (control == 0) {
            ...
            switch (seleccion) {
                ...
                case 3 -> {
                    System.out.println("Introduce el titulo de la tarea a buscar:\n");
                    String titulo =  scan.nextLine();
                    ...
                    if (eleccion.equals("s")) {
                        if (tareaBuscada != null) {
                            ...
                            switch (eleccion_n) {
                                case 1:
                                    System.out.println("Titulo actual: "+tareaBuscada.getNombre()+"  Nuevo titulo: ");
                                    String new_titulo = scan.nextLine();
                                    tareaBuscada.setNombre(new_titulo);
                                    break;
                                case 2:
                                    System.out.println("Descripcion actual: "+tareaBuscada.getDescripcion()+"  Nuevo descripcion: ");
