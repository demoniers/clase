            ...
            <table className="tabla-caracteristicas">
              <tbody>
                <tr>
                  ...
                  <td>{cocheSeleccionado.aceleracion} s</td>
                </tr>
                <tr>
                  <td>Consumo:</td>
                  <td>{cocheSeleccionado.consumo} l/100 km</td>
                </tr>
                <tr>
                  <td>Par máximo:</td>
                  <td>{cocheSeleccionado.newtons_par} Nm</td>
                </tr>
                <tr>
                  <td>Caballos:</td>
                  <td>{cocheSeleccionado.caballos} CV</td>
                </tr>
                <tr>
