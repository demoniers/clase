...
app.post('/agregar-competicion', (req, res) => {
  const { descripcion, horaInicio, horaFin, fechaInicio, fechaFin } = req.body;
  db.run('INSERT INTO competiciones (descripcion, horaInicio, horaFin, fechaInicio, fechaFin) VALUES (?, ?, ?)', [descripcion, horaInicio, horaFin, fechaInicio, fechaFin ], (err) => {
    if (err) {
      throw err;
    }
    res.redirect('/');
